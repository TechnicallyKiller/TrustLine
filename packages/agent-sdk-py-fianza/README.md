...
Python port of the TypeScript [`@fianza/agent-sdk`](../agent-sdk); the
two speak the same backend API and on-chain contracts.

[![PyPI](https://img.shields.io/pypi/v/fianza-agent-sdk.svg)](https://pypi.org/project/fianza-agent-sdk/)
