#!/usr/bin/env python3
"""Fianza agent-sdk (Python) quickstart -- a genuine, runnable end-to-end walk.

Generates a fresh Stellar testnet keypair, funds it (Friendbot XLM + a Fianza
...
API = os.environ.get("TRUSTLINE_API", "https://fianza-5m68.onrender.com")
...
def main():
    ...
    tl = FianzaAgent(keypair.secret, api_base_url=API)
