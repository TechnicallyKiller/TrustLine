...
zkTLS-attested off-chain income), underwritten by the TrustLine engine. Settles in
...
scoring is delegated to the TrustLine underwriting engine (the trusted underwriter
